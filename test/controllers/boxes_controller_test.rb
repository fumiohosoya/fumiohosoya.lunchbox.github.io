...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { content: @box.content, name: @box.name, price: @box.price, tagname: @box.tagname }
    end
  ...
  test "should update box" do
    patch :update, id: @box, box: { content: @box.content, name: @box.name, price: @box.price, tagname: @box.tagname }
    assert_redirected_to box_path(assigns(:box))
  end
